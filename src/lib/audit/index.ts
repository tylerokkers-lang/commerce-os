...
export type AuditAction =
  ...
  | 'PRODUCT_DECISION_CHANGED' | 'CHANNEL_DECISION_CHANGED'
  ...
  | 'MARKETPLACE_CONNECTOR_VERIFIED'
  ...
  // Supplier discovery (Phase 5)
  | 'CANDIDATE_CAPTURED' | 'CANDIDATE_POSSIBLE_DUPLICATE' | 'CANDIDATE_IMPORT_BLOCKED'
  | 'CANDIDATE_IMPORTED' | 'CANDIDATE_REJECTED'
  // Product media intelligence (Phase 7)
  | 'MEDIA_CAPTURED' | 'MEDIA_VALIDATED' | 'MEDIA_APPROVED' | 'MEDIA_REJECTED'
  | 'MEDIA_SET_PRIMARY' | 'MEDIA_REMOVED'
  // Real supplier connector (Phase 8)
  | 'SUPPLIER_SHIPPING_QUOTED' | 'SUPPLIER_PRODUCT_DISCOVERED'
  // Orders
