...
const CAMPAIGNS: FactBundle['advertisingCampaigns'] = [
  { campaignKey: 'amazon_uk:camp-1', campaignName: 'Summer Sale Blitz', channel: 'amazon_uk', isPaused: false, spend: '£280.00', attributedRevenue: '£0.00', roas: 'unavailable — no revenue', acosPct: 'unavailable — no revenue', classification: 'wasted_spend', severity: 'critical', reasons: [], externalCampaignId: 'camp-1', provider: 'amazon_ads', externalAccountId: 'acct-1', dailyBudgetMinor: 5000, productId: 'p1' },
  { campaignKey: 'shopify:camp-2', campaignName: 'Evergreen Brand Awareness', channel: 'shopify', isPaused: false, spend: '£100.00', attributedRevenue: '£600.00', roas: '6.00', acosPct: '16.7%', classification: 'scale_opportunity', severity: 'info', reasons: [], externalCampaignId: 'camp-2', provider: 'meta_ads', externalAccountId: 'acct-2', dailyBudgetMinor: 3000, productId: 'p2' },
  { campaignKey: 'amazon_uk:camp-3', campaignName: 'Sale', channel: 'amazon_uk', isPaused: false, spend: '£50.00', attributedRevenue: '£150.00', roas: '3.00', acosPct: '33.3%', classification: 'healthy', severity: 'info', reasons: [], externalCampaignId: 'camp-3', provider: 'amazon_ads', externalAccountId: 'acct-1', dailyBudgetMinor: 1500, productId: 'p3' }, // deliberately a substring of "Summer Sale Blitz" to test ambiguity
]
